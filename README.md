...
В файле [profiles/profiling.md](./profiles/profiling.md) можно найти подробное описание процесса профилирования памяти. Здесь показан только результат одной из оптимизаций, выполненных с помощью pprof.
